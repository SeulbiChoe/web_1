(function (root, factory) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template = '<div class="daterangepicker ' + (this.inline ? 'daterangepicker-inline' : 'daterangepicker-tooltip dropdown-menu') + '">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input py-4">' +
                    '<p class="text-secondary mb-0">예약일</p>' +
                      '<div><span>Check in</span><input class="input-mini border-0 bg-transparent" type="text" name="daterangepicker_start" style="width: 100px;"  value="" disabled />' +
                      '<span>Check out</span><input class="input-mini border-0 bg-transparent" type="text" name="daterangepicker_end" style="width: 100px;"  value="" disabled /></div>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (side) {
            ...
            var dateHtml = '<span class="title-year px-2">' + calendar[1][1].format(" YYYY") + '년</span>' + this.locale.monthNames[calendar[1][1].month()];
